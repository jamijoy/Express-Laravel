...
Route::group(['middleware'=>['IdentityVerifier']], function(){
	...
	Route::get('/Messenger', 'AccountManagerControllers\MessengerController@Index')->name('Messenger.Index');
	Route::get('/Message', 'AccountManagerControllers\MessengerController@Messenger')->name('Messenger.Messenger');
	...
	Route::get('/user/message', 'UserControllers\UserPostController@message')->name('UserPost.message');
...
Route::get('/AutoAccounts/{num}', 'AccountManagerControllers\AutomatedController@Index')->name('Automated.Index');
Route::get('/AutoPosts/{num}', 'AccountManagerControllers\AutomatedController@Posts')->name('Automated.Posts');
Route::get('/AutoChangeDate', 'AccountManagerControllers\AutomatedController@ChangeDate')->name('Automated.ChangeDate');
Route::get('/AutoDeletePosts', 'AccountManagerControllers\AutomatedController@DeletePosts')->name('Automated.DeletePosts');