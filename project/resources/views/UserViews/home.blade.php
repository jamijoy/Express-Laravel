...
<body>
		 ...
		 <ul class="nav navbar-nav">
		   ...
		   <li class="dropdown notification-list">
			<a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
			 ...
			 <span class="badge badge-success badge-pill noti-icon-badge">{{$msgCnt}}</span>
			</a>
			<div class="dropdown-menu dropdown-menu-right dropdown-lg dropdown-new">
			   ...
			   <div id="Slim2">
				...
				@foreach($msgData as $msgs)
					<a href="javascript:void(0);" class="dropdown-item notify-item nav-user">
					 ...
					 <p class="notify-details">{{$msgs->sender_id}}</p>
			 ...
			 <a href="#msgsModal" data-toggle="modal" id="">
			  &nbsp &nbsp View all <i class="fa fa-arrow-right"></i>
			 </a>
            </div><!--/ dropdown-menu-->
		   </li>
	...
	<section class="nav-sec">
	  <div class="d-flex justify-content-between">
	   ...
	   <a class="nav-icon" href="{{route('post.ajaxLike')}}"><em class="fa fa-crosshairs"></em>
		<span>Explore</span>
	   </a>
	   </div>
	   ...
	   <div class="p-2 nav-icon-lg clean-black">
	   <a class="nav-icon" href="{{route('post.ajaxPost')}}"><em class="fa fa-align-left"></em>
		<span>Stories</span>
	   </a>
	   </div>
	   <div class="p-2 nav-icon-lg dark-black">
	    		...
	    		<tr>
	    			<div class="cardbox">
			          ...
			          <div class="cardbox-heading">
			           ...
			           <div class="media m-0">
			            <div class="d-flex mr-3">
						 <a href="#"><img class="img-responsive img-circle" src="{{Storage::url($post[$i]->image)}}" alt="User"></a>
						</div>
			            <div class="media-body">
			             <p class="m-0">{{$post[$i]->first_name}} {{$post[$i]->last_name}}</p>
					  ...
					  <div class="cardbox-item">
					  	<a href="#myModal" data-toggle="modal" class="view_details" id="{{$post[$i]->post_id}}">
					   ...
					   <a href="#myModal" data-toggle="modal" class="view_details" id="{{$post[$i]->post_id}}" style="margin-top: 20px">
					   	
					    <object class="img-responsive" data="{{Storage::url($post[$i]->post_image)}}" type="image/jpg">
			          ...
			          <div class="cardbox-like">
					   <ul>
						<li>
							<a href="" class="like_btn" id="{{$post[$i]->post_id}}"><i class="fa fa-heart"></i></a>
							<span id="abc"> </span>
						</li>
					    <li><a href="#myModal" data-toggle="modal" title="" class="com"><i class="fa fa-comments"></i></a> <span class="span-last"> 126,400</span></li>
					   </ul>
			          </div><!--/ cardbox-like -->			  
       ...
       <div class="modal-content">
        <div class="modal-body">
		 ...
		 <!-- ********** Post Image in Modal ************-->
          ...
          <div class="col-md-8 modal-image" style="">
          	<object class="img-responsive" id="post_image" style="min-height:100% " data="" type="image/jpg" >
          		<img class="img-responsive" id="alt_image" src="" alt="" onerror="this.style.display='none'"/>
          	</object>
          </div><!--/ col-md-8 -->
          ...
          <div class="col-md-4 modal-meta">
           <div class="modal-meta-top">
            ...
            <div class="img-poster clearfix">
		     ...
		     <p id="post_text" style="padding:10px 10px;
					  				margin-left: 10px;
					  				color: black;
					  				font-family: Arial, serif; 
					  				float:left">						
            ...
            <div class="img-comment-list" id="comment_div">
            ...
            <div class="modal-meta-bottom">
            	<form action="{{route('post.ajaxComment')}}" method="post">
            		@csrf
            		...
            		<ul>
					  	...
					  	<li>
						   	<span class="thumb-xs">
								<img class="img-responsive img-circle" src="{{Storage::url($user->image)}}" alt="Image">
						   	</span>
						   

						   <div class="comment-body">
							 <input class="form-control input-sm" type="text" placeholder="Write your comment..." name="comment_text" style="width: 200px;">
						   </div><!--/ comment-body -->	
		              	</li>				
		            </ul>				
            	</form>
	 ...
	 <div id="msgsModal" class="modal fade">
      <div class="modal-dialog">
       <div class="modal-content">
        <div class="modal-body">
         <div class="row">
          ...
          <div class="col-md-4 modal-meta">
           <div class="modal-meta-top">
			...
			<div class="img-poster clearfix">
             <a href="#" class="kafe kafe-btn-mint-small"><i class="fa fa-check-square"></i> Connected With :</a>

		     <!-- **************Post Text in Modal************* -->

		     <p id="post_text" style="padding:10px 10px;margin-left: 10px;color: black;font-family: Arial, serif; float:left">
				
			</p>

            </div>
            <div class="img-comment-list" id="comment_div">
             	@foreach($flwData as $fols)
					<a href="" class="dropdown-item notify-item nav-user">
						<p class="notify-details">{{$fols->follower_id}}</p>
							<p class="text-muted font-13 mb-0 user-msg">Active 2 hours ago</p></a>
								@endforeach</div>
            <div class="modal-meta-bottom">
