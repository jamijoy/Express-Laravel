...
<html lang="en">
    <head>
		...
		function drawChart() {
		  ...
		  dataTable.addRow([{ v: 'Unblocked' },{ v: 273 }]);
		  dataTable.addRow([{ v: 'Blocked' },{ v: 31 }]);
		  ...
		  var options = {title: 'Account Status Report'};
                    ...
                    <div class="col-xl-6">
                        <div class="credential-content">
                            <div id="piechart" class="chart-panel">	
								<input type="text" id="dataCar" value="{{$tots}}" hidden="true">
									</div>
										</div>
                    </div>
                    <div class="col-xl-6">
